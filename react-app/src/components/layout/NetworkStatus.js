...
export const NetworkStatus = ({ isModal = false, onClose, compact = false }) => {
    ...
    const content = (_jsxs("div", { className: styles.networkStatus, children: [_jsxs("div", { className: styles.header, children: [_jsxs("h3", { children: [theme === 'artsnob' && 'Network Telemetry', theme === 'standard' && 'Network Status', theme === 'minimal' && 'Status'] }), lastUpdate && (_jsxs("span", { className: styles.lastUpdate, children: ["Updated: ", lastUpdate.toLocaleTimeString()] })), isModal && (_jsx("button", { className: styles.closeButton, onClick: handleClose, children: _jsx("i", { className: "fas fa-times" }) }))] }), _jsxs("div", { className: styles.statusGrid, children: [_jsxs("div", { className: `${styles.statusItem} ${styles[health?.status || 'unknown']}`, children: [_jsx("i", { className: "fas fa-server" }), _jsxs("div", { className: styles.statusInfo, children: [_jsx("span", { className: styles.label, children: "Server" }), _jsx("span", { className: styles.value, children: health?.serverStatus || 'Unknown' })] })] }), _jsxs("div", { className: `${styles.statusItem} ${styles[connected ? 'ok' : 'degraded']}`, children: [_jsx("i", { className: "fas fa-plug" }), _jsxs("div", { className: styles.statusInfo, children: [_jsx("span", { className: styles.label, children: "WebSocket" }), _jsx("span", { className: styles.value, children: connected ? `Connected (${health?.socketConnections || 0} clients)` : 'Disconnected' })] })] }), _jsxs("div", { className: `${styles.statusItem} ${styles[health?.midiDevicesConnected ? 'ok' : 'unknown']}`, children: [_jsx("i", { className: "fas fa-music" }), _jsxs("div", { className: styles.statusInfo, children: [_jsx("span", { className: styles.label, children: "MIDI Devices" }), _jsxs("span", { className: styles.value, children: ["Server: ", health?.midiDevicesConnected || 0, ", Browser: ", activeBrowserInputs?.size || 0] })] })] }), _jsxs("div", { className: `${styles.statusItem} ${styles[health?.artnetStatus === 'initialized' ? 'ok' : 'degraded']}`, children: [_jsx("i", { className: "fas fa-network-wired" }), _jsxs("div", { className: styles.statusInfo, children: [_jsx("span", { className: styles.label, children: "ArtNet" }), _jsx("span", { className: styles.value, children: health?.artnetStatus || 'Unknown' })] })] }), _jsxs("div", { className: styles.statsSection, children: [_jsxs("div", { className: styles.stat, children: [_jsx("span", { className: styles.label, children: "Uptime" }), _jsx("span", { className: styles.value, children: health ? formatUptime(health.uptime) : 'Unknown' })] }), _jsxs("div", { className: styles.stat, children: [_jsx("span", { className: styles.label, children: "Memory" }), _jsx("span", { className: styles.value, children: health?.memoryUsage ? formatMemory(health.memoryUsage.heapUsed) : 'Unknown' })] })] })] })] }));
    if (compact) {
