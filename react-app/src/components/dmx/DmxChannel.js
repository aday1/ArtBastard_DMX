    ...
    useEffect(() => {
        const handleDmxChannelUpdate = (event) => {
            ...
            if (customEvent.detail && customEvent.detail.channel === index) {
                ...
                const slider = document.querySelector(`[data-dmx-channel="${index}"] input[type="range"]`);
                if (slider) {
